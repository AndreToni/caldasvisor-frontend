    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <div className='flex flex-col gap-6'>
                {tickets.map(item => <div className='flex flex-wrap items-center gap-4 bg-shapes-background-aux p-4 border border-grey1 rounded'>
                    ...
                    <ButtonSecondary label="Acessar link de compra" onClick={() => {}}/>
                </div>)}
            </div>
        </div>
    )
